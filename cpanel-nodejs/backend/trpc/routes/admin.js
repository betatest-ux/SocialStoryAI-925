...
import { getUserData, getAllUsers, updateUser, deleteUser } from "../../db/users.js";
import { getAllStories, deleteStory } from "../../db/stories.js";
import { getAdminSettings, updateAdminSettings, getApiKeys, updateApiKeys, addActivityLog, getActivityLogs } from "../../db/admin.js";
import { z } from "zod";
...
export const adminRouter = createTRPCRouter({
  analytics: protectedProcedure.query(async ({ ctx }) => {
    ...
    const storiesPerDay = stories.reduce((acc, story) => {
  ...
  togglePremium: protectedProcedure
    ...
    .mutation(async ({ ctx, input }) => {
      ...
      const updates = { isPremium: newPremiumStatus };
